...
<head>
    ...
    <title>Manage Location Pricing - BillboardX</title>
    ...
    <div class="main-wrapper">
        ...
        <header class="topbar">
            ...
            <div class="breadcrumbs">
                ...
                <i class="fa-solid fa-chevron-right"></i>
                <span>Location Pricing Matrix</span>
            </div>
        ...
        <main class="content">
            <div class="header-section">
                <h1 class="page-title">Location-Size Matrix Pricing</h1>
                <p class="page-subtitle">Configure operational rates and status availability for billboards based on location and dimension specs.</p>
            </div>

            <div class="layout-grid">
                
                <!-- Left Panel: Pricing Form Card -->
                <div class="card">
                    <div class="card-header">
                        <i class="fa-solid fa-tags"></i>
                        <h2>Set Rate & Availability</h2>
                    </div>
                    <div class="card-body">
                        <form action="LocationSizeController.jsp" method="post">
                            
                            <div class="form-group">
                                <label for="locationId">Target Location</label>
                                <select id="locationId" name="locationId" class="input-control" required>
                            ...
                            <div class="form-group">
                                <label for="sizeId">Billboard Dimension Size</label>
                                <select id="sizeId" name="sizeId" class="input-control" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" id="price" name="price" class="input-control" placeholder="0.00" required />
                            </div>

                            <div class="form-group">
                                <label for="status">Initial Operational Status</label>
                                <select id="status" name="status" class="input-control" required>
                            ...
                            <button type="submit" class="btn-submit">
                                <i class="fa-solid fa-floppy-disk"></i> Save Rate Mapping
                            </button>
                        </form>
                    </div>
                </div>

                <!-- Right Panel: Data Records Table -->
                <div class="card">
                    <div class="card-header">
                        <i class="fa-solid fa-table-list"></i>
                        <h2>Current Location-Size Pricing Matrix</h2>
                    </div>
                                ...
                                <%
                                    ...
                                    if (matrixList != null && !matrixList.isEmpty()) {
                                        for(LocationSizeBean matrix : matrixList) {
                                            String statusClass = "Maintenance".equalsIgnoreCase(matrix.getStatus()) ? "status-maintenance" : "status-available";
                                            String statusIcon = "Maintenance".equalsIgnoreCase(matrix.getStatus()) ? "fa-wrench" : "fa-circle-check";
                                %>
                                <tr>
                                    <td style="width: 70px;"><span class="id-badge">#<%= matrix.getLocationsize_id() %></span></td>
                                    <td><strong><%= matrix.getLocationName() %></strong></td>
                                    <td><i class="fa-solid fa-ruler-combined" style="color: var(--text-muted); margin-right: 0.25rem;"></i> <%= matrix.getBillboardSizeText() %></td>
                                    <td class="price-text">$<%= String.format("%.2f", matrix.getPrice()) %></td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div class="empty-state">
                                            ...
                                            <p>No pricing mappings found. Use the form on the left to set up location rates.</p>
                                        </div>
                                    </td>
                                </tr>
                                <% } %>
