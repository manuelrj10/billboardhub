...
<head>
    ...
    <title>Manage Customers - BillboardX</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="ManageCustomers.jsp" class="nav-link active">
    ...
    <div class="main-wrapper">
        ...
        <main class="content">
            <div class="header-section">
                <h1 class="page-title">Customer Profiles Management</h1>
                <p class="page-subtitle">Register new advertiser clients and view corporate customer contacts.</p>
            </div>
                    ...
                    <div class="card-body">
                        <form action="CustomerActionControl.jsp" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="companyName" name="companyName" class="input-control" placeholder="e.g. Acme Corporation" required />
                            </div>

                            <div class="form-group">
                                <label for="contactPerson">Contact Person Name</label>
                                <input type="text" id="contactPerson" name="contactPerson" class="input-control" placeholder="e.g. Jane Doe" required />
                            </div>

                            <div class="form-group">
                                <label for="phone">Phone Contact Number</label>
                                <input type="tel" id="phone" name="phone" class="input-control" placeholder="e.g. +1 (555) 000-0000" required />
                            </div>

                            <button type="submit" class="btn-submit">
                                <i class="fa-solid fa-check-circle"></i> Register Customer
                            </button>
                        </form>
                    </div>
                </div>

                <!-- Right Column: Registered Customers Table -->
                <div class="card">
                    <div class="card-header">
                        <i class="fa-solid fa-address-book"></i>
                        <h2>Registered Customer Clients</h2>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 100px;">
                                        <span class="id-badge">#<%= client.getCustomerId() %></span>
                                    </td>
                                    <td>
                                        <div class="company-cell">
                                            ...
                                            <strong><%= client.getCompanyName() %></strong>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <div class="empty-state">
                                            ...
                                            <p>No customer profiles found. Register your first customer using the form on the left.</p>
                                        </div>
                                    </td>
                                </tr>
                                <% } %>
